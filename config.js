...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'MADE BY STELLA' : process.env.ALL_CAPTION,
    ...
    ZARA_AI: process.env.STELLA_AI === undefined ? 'false' : process.env.STELLA_AI,
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://github.com/riz4d/stella/blob/main/stella-req/stella.jpg' : process.env.GAN_IMAGE,
    ...
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://github.com/riz4d/stella/blob/main/stella-req/stella.jpg' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://github.com/riz4d/stella/blob/main/stella-req/stella.jpg' : process.env.GIF_BYE,

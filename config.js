...
module.exports = {
    VERSION: 'v3.0.0',
    CHANNEL: 'https://t.me/riz4d',
    SESSION: process.env.STELLA_STRING === undefined ? '' : process.env.STELLA_STRING,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AFN: process.env.ALL_CAPTION === undefined ? '*STELLA*' : process.env.ALL_CAPTION,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://raw.githubusercontent.com/riz4d/stella/main/stella-req/stella.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    AFNN: process.env.TAG_REPLY === undefined ? '919079534@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '91628239' : process.env.ALL_NUMBER,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'rizad¹¹' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'STELLA' : process.env.BOT_NAME,
    SUPPORT: process.env.ASENA === undefined ? '919074309534-1632403322' : process.env.ASENA,
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://raw.githubusercontent.com/riz4d/stella/main/stella-req/stella.jpg' : process.env.GIF_WEL,
    ...
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://raw.githubusercontent.com/riz4d/stella/main/stella-req/stella.jpg' : process.env.GIF_BYE,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://raw.githubusercontent.com/riz4d/stella/main/stella-req/stella.jpg' : process.env.ALL_IMG,
    ...
    SUDO: process.env.SUDO === undefined ? '919074534,0' : process.env.SUDO,
    DEBUG: DEBUG,

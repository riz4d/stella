...
Stella.addCommand({pattern: 'ban ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.BAN_DESC}, (async (message, match) => {  
...
Stella.addCommand({pattern: 'add(?: |$)(.*)', fromMe: false, onlyGroup: true, desc: Lang.ADD_DESC}, (async (message, match) => {  
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Stella.addCommand({pattern: 'promote ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.PROMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Stella.addCommand({pattern: 'demote ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.DEMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
...
Stella.addCommand({pattern: 'mute ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.MUTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Stella.addCommand({pattern: 'unmute ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.UNMUTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Stella.addCommand({pattern: 'invite ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.INVITE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
...
Stella.addCommand({pattern: 'rename ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.RENAME_DESC}, (async (message, match) => {
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
...
Stella.addCommand({pattern: 'revoke', fromMe: false, onlyGroup: true, desc: Lang.REVOKE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
...
Stella.addCommand({pattern: 'vip', fromMe: false, onlyGroup: true}, (async (message, match) => {
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
    await message.sendMessage('┏┏━━━━━━━━━━━━━━━━━━━ \ n┃〘 * VIP MENU *〙 \ n┗━━━━━━━━━━━━━━━━━━ ━ \ n * 🛑 Command: * \ n / add \ n * 💬 Description: * \ nAdd people to the group. \ N❓ Example: / add 57301xxxxxxx \ n \ n * 🛑 Command: * \ n / ban \ n * 💬 Description: * \ nRemove a person from the group. (Reply or tag the person next to the command). \ N \ n * 🛑 Command: * \ n / promote \ n * 💬 Description: * \ nPromote anyone to administrator. \ N \ n * 🛑 Command: * \ n / demote \ n * 💬 Description: * \ nRemove Administrator position \ n \ n * 🛑 Command: * \ n / mute \ n * 💬 Description: * \ nChat from closed group. Now only administrators can post messages. \ N \ n * 🛑 Command: * \ n / unmute \ n * 💬 Description: * \ nOpen the group chat. Now anyone can send a message. \ N \ n * 🛑 Command: * \ n / invite \ n * 💬 Description: * \ nDisplays the group invite link. \ N \ n * 🛑 Command: * \ n / welcome \ n * 💬 Description: * \ nSets a welcome message. If you do not write a message, the default welcome message will appear. \ N \ n * 🛑 Command: * \ n / goodbye \ n * 💬 Description: * \ nSets a goodbye message. If you do not type a message, the default welcome message will appear. \ N \ n * 🛑 Command: * \ n / block \ n * 💬 Description: * \ nBlock a person. \ N \ n * 🛑 Command: * \ n / unblock \ n * 💬 Description: * \ nUnblock a person. \ n \ n * 🛑 Command: * \ n / tagall \ n * 💬 Description: * \ n Mentions all users in the group. \ n \ n * 🛑 Command: * \ n / tagadmin \ n * 💬 Description: * \ n Mentions all admins in the group. \ N┏━━━━━━━━━━━━━━━━━━━ \ n * Stella * the best 😉 \ n┗━━━━━━━━━━━━━━━━━━━ \ n');
}));

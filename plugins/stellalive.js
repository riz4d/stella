...
Rizad.tostella({pattern: 'stella', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'stella', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

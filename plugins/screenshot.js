...
if (Config.WORKTYPE == 'private') {
    ...
    Rizad.tostella({pattern: 'ss ?(.*)', fromMe: true, desc: Lang.SS_DESC}, (async (message, match) => {
    ...
    Rizad.tostella({pattern: 'ss ?(.*)', fromMe: false, desc: Lang.SS_DESC}, (async (message, match) => {

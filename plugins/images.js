...
if (Config.WORKTYPE == 'private') {
    ...
    MyStella.tostella({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'by stella'})

    }));
    
    MyStella.tostella({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    MyStella.tostella({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    MyStella.tostella({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    MyStella.tostella({pattern: 'song', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[1] = "aarellum aaa sed bgm onn iduo...";
r_text[2] = "Stella says i love you 😘";
r_text[4] = "hy, how you";
...
r_text[11] = "do you know who is my creator..?";
...
r_text[13] = ".isong adich fav song name para stella ath download aakki theraam";
...
r_text[17] = "\n hey mister ningalude per entha..?";

...
if (con.LANG === 'TR') {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Rizad.tostella({pattern: 'roll', fromMe: true, desc: TRZAR}, (async (message, match) => {
        ...
        Rizad.tostella({pattern: 'roll', fromMe: false, desc: TRZAR}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Rizad.tostella({pattern: 'roll', fromMe: true, desc: HIZAR}, (async (message, match) => {
        ...
        Rizad.tostella({pattern: 'roll', fromMe: false, desc: HIZAR}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Rizad.tostella({pattern: 'roll', fromMe: true, desc: ENZAR}, (async (message, match) => {
        ...
        Rizad.tostella({pattern: 'roll', fromMe: false, desc: ENZAR}, (async (message, match) => {

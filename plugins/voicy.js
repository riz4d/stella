...
if (conf.WORKTYPE == 'private') {
    ...
    Rizad.tostella({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Rizad.tostella({ pattern: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
